                              ...
                              <div className="container">
                                    ...
                                    <Collapse isOpen={this.state.isNavOpen} navbar>
                                          <Nav navbar>
                                                ...
                                                <NavItem>
                                                      <NavLink className="nav-link" to="/contactus"><span className="fa fa-address fa-lg"></span> Contact Us
                                                </NavLink>
                                                </NavItem>
                                          </Nav>
                              ...
                              <div className="container">
                                    <div className="row row-header">
                                          <div className="col-12 col-sm-6">
                                                ...
                                                <p>We take inpiration from the world's best cuisines and create a unique fusion experience. Our lipsmacking creations will tikle your culinary senses.</p>
                                          </div>
                                    </div>
                              </div>
                  </Jumbotron>
                  <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
                        ...
                        <ModalBody>
                              <Form onSubmit={this.hadleLogin}>
                                    ...
                                    <Button type="submit" value="submit" className="bg-dark-gray">Login</Button>
                              </Form>
                        </ModalBody>
                  </Modal>
                  </React.Fragment>
